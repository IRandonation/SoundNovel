...
- **前3章正文全文**: 原文注入不做摘要，保证文风、语气、细节的连贯

上下文窗口参数: `outline_window`（默认30）、`draft_window`（默认3）。
...
| `generation.json` | 生成参数 | `{"outline_window": 30, "draft_window": 3}` |
