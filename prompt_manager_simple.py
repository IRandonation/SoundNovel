...
【改写核心要求】
1. 保持原文核心情节、人物关系、世界观设定完全不变
2. 确保改写后字数与原文相近（误差控制在±15%以内），绝不能变成总结或缩写
3. 严格遵循世界观设定，自然融入风格特征
4. 合理运用指定文学手法，增强文本表现力
5. 保持人物性格一致性，确保剧情逻辑连贯
6. 避免直接复制原文句式，但必须保留所有细节内容
7. 重点保留：环境描写、人物心理活动、对话内容、动作细节、修炼过程等
8. 改写的是表达方式，不是内容本身。内容要丰富详实，不能简化
9. 保持段落结构完整性，确保上下文衔接自然流畅

【重要提醒】
- 绝对不能省略任何细节内容，不能变成概括性描述
- 必须保留原文的丰富性和生动性
- 改写的是语言表达，不是内容压缩
- 确保改写后的文本同样详实具体，充满细节
...
请直接输出改写后的文本，不要添加任何说明或解释。""",
            ...
            "user_prompt": """请改写以下文本，注意保持字数相近且内容丰富：

【原文】
{text}

【改写要求】
1. 保持核心情节、人物关系、世界观设定完全不变
2. 重塑表达方式，但必须保留所有细节内容，不能简化
3. 确保改写后字数与原文相近（误差控制在±15%以内）
4. 重点保留：环境描写、人物心理活动、对话内容、动作细节、修炼过程等
5. 自然融入世界观和风格特征
6. 遵循上述文学手法要求
7. 绝对不能变成总结或缩写，必须保持原文的丰富性和生动性
...
- 确保改写后的文本同样详实具体，充满细节""",
            ...
            "long_text_user_prompt": """请改写以下长文本段落，注意保持情节连贯性和字数相近，同时确保内容丰富：

【原文 - 文本块 {chunk_id}】
{text}

【长文本改写要求】
1. 保持核心情节、人物关系和世界观设定完全不变
2. 重塑表达方式，但必须保留所有细节内容，不能简化或总结
3. 确保改写后字数与原文相近（误差控制在±15%以内）
4. 重点保留：环境描写、人物心理活动、对话内容、动作细节、修炼过程等
5. 充分利用长文本优势，保持上下文连贯性和情节发展逻辑
6. 自然融入世界观和风格特征，确保人物性格一致性
7. 遵循上述文学手法要求，注重修炼体系和境界描写
8. 确保段落结构完整，上下文衔接自然流畅
...
4. 重点保留：环境描写、人物心理活动、对话内容、动作细节、修炼过程等
5. 充分利用1M上下文优势，保持超长文本的上下文连贯性和情节发展逻辑
