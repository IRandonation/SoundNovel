...
class APIConfigState:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "APIConfigState":
        return cls(
            ...
            api_base_url=data.get("api_base_url", "https://open.bigmodel.cn/api/paas/v4"),
            models=data.get("models", {}),
            deepseek_api_key=data.get("deepseek_api_key", ""),
            deepseek_api_base_url=data.get("deepseek_api_base_url", "https://api.deepseek.com"),
...
class AIRolesState:
    """所有AI角色的状态"""
    generator: AIRoleState = field(default_factory=lambda: AIRoleState(
        provider="zhipu", model="glm-4.5-flash", temperature=0.7, top_p=0.9, max_tokens=8000
    ))
    reviewer: AIRoleState = field(default_factory=lambda: AIRoleState(
        provider="deepseek", model="deepseek-chat", temperature=0.3, top_p=0.7, max_tokens=4000
    ))
    refiner: AIRoleState = field(default_factory=lambda: AIRoleState(
...
class SessionState:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "SessionState":
        return cls(
            ...
            generation_state=GenerationState.from_dict(data.get("generation_state", {})),
...
class SessionManager:
    ...
    def get_api_config(self) -> Dict[str, Any]:
        ...
        if api_state.provider == "zhipu":
            config["api_key"] = api_state.api_key
            config["api_base_url"] = api_state.api_base_url
            config["models"] = api_state.models
        elif api_state.provider == "doubao":
            config["doubao_api_key"] = api_state.api_key
            config["doubao_api_base_url"] = api_state.api_base_url
            config["doubao_models"] = api_state.models
        elif api_state.provider == "ark":
            config["ark_api_key"] = api_state.api_key
            config["ark_models"] = api_state.models
        elif api_state.provider == "deepseek":
            config["deepseek_api_key"] = api_state.deepseek_api_key
            config["deepseek_api_base_url"] = api_state.deepseek_api_base_url
            config["deepseek_models"] = api_state.deepseek_models
    ...
    def set_api_config(
        ...
        self.state.api_config.api_key = api_key
        
        if api_base_url:
            self.state.api_config.api_base_url = api_base_url
        elif provider == "zhipu":
            self.state.api_config.api_base_url = "https://open.bigmodel.cn/api/paas/v4"
        elif provider == "doubao":
            self.state.api_config.api_base_url = "https://ark.cn-beijing.volces.com/api/v3"
        ...
        if provider == "deepseek":
            ...
            self.state.api_config.models = models
    ...
    def get_status_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "api_configured": bool(self.state.api_config.api_key),
